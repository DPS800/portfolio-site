...
function setup() {
  describe(
    'Second find my face scratch card. The cursor, when dragged across the card, scratches at the squares with a coin to reveal them.'
  );
...
//     case ('4') : [bottomImg = loadImage('../img/DGfindmyface3.png')] ;
//     case ('4') : [topImg = loadImage('../img/DGfindmyface2.png')] ; break;

//     case ('3') : [bottomImg = loadImage('../img/DGfindmyface3.png')] ;
//     case ('3') : [topImg = loadImage('../img/DGfindmyface2.png')] ; break;
...
// var sTwo = function( p ) { // p could be any variable name
//   setup = function() {
//     p.describe(
